...
// Jika tidak ada session pelanggan, maka redirect ke login.php
        ...
        <div class="container">
            ...
            if (isset($_POST["checkout"])) {
                ...
                foreach ($_SESSION["keranjang"] as $id_produk => $jumlah) {
                    ...
                    $koneksi->query("INSERT INTO detail_pembelian (id_pembelian, id_produk, nama, harga, jumlah, subharga)
                                     VALUES ('$id_pembelian_barusan', '$id_produk', '$nama', '$harga', '$jumlah', '$subharga')");
                }
